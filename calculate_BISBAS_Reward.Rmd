...
# Read in data.
nda30 = readRDS(paste(data_directory,"nda30.rds",sep="/"))

# Change to numeric.
nda30$bisbas8_y = as.numeric(nda30$bisbas8_y)
nda30$bisbas9_y = as.numeric(nda30$bisbas9_y)
nda30$bisbas11_y = as.numeric(nda30$bisbas11_y)
nda30$bisbas12_y = as.numeric(nda30$bisbas12_y)
